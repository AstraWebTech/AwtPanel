...
const {fields, validate, getFieldsDataToRequest, clearValues} = useForm([
  ...
  { key: "name", name: 'login', label: t('parameters.user'), required: true, validate: false },
  { key: "password", required: true, validate: false },
  { key: "name", name: 'host',  label: t('parameters.host'), required: true, validate: false },
], [
